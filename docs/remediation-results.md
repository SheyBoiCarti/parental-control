...
- This browser fixture does not establish Linux deployment, HTTPS deployment, socket expiry/concurrency behavior, packet enforcement, real host networking, or privileged kernel-adapter acceptance.
